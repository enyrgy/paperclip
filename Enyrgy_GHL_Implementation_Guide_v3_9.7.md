...
Powered by Paperclip Autonomous Agents · Version 3.9.7
...
Last Updated: August 25, 2026 · Version 3.9.7
...
| **Metric** | **Value** | **Notes** |
|---|---|---|
| Users | 600+ | Organic growth, zero paid advertising to date |
...
**SALES ANCHOR:** No other solution delivers all three simultaneously. Supplements = Vitamin D only. Sunlight = 60x more time + cancer risk. Red light = different mechanism entirely (90% of Enyrgy users use both). Enyrgy is a new category.
...
Clinical study data (+111% Vitamin D, 100% reached optimal, 12-week study); advisor bios (Dr. Bruce Hollis, Dr. Samantha Kimball, Dr. William Grant); all approved talking points (Section 15); all objection scripts (Section 22); current pricing; per-session cost $1.15; facility 5115 N 27th Ave, Bld 66, Phoenix, AZ 85017; prohibited words (Section 14); referral terms; ROI model (6.0x Year-1); **ATTORNEY CONFIRMED: PPM may be sent after intro meeting without accreditation. Accreditation required before accepting investment. Not before PPM.**
...
|---|---|---|---|
| Investor Intro Call | Personal | Brian | 15 min |
| Investor Presentation | Collective | Scott + Brian | 30 min |
| Consumer Discovery Call | Round Robin | Millie | 15 min |
...
| David Letourneau | EVP Operations & Co-Founder | david@enyrgy.com | 602-625-6607 |
...
|---|---|---|
| Consumer | Millie | Scott |
| Commercial | Scott | Brian |
| Investor (Intro) | Brian | Scott |
| Investor (Presentation/Close) | Scott | Brian |
| Partner | Scott | --- |
| Vendor | Scott | --- |
| Onboarding | Scott | --- |
...
| 2 Commercial B2B Pipeline | Registration Submitted -> Conflict Check -> Prospect -> Drip Active -> Discovery -> Proposal -> Negotiation -> Contract Signed -> Unit Shipped -> User Activated -> Installation -> Training Scheduled -> Training Complete -> Active Customer |
...
| 8                 12 |  | Email | What would $2,995 cost per session? ($1.15 at 5x/week over 5 years) |
...
| WF-20 Winter Protocol Emails | Contact Tag (magnet_winter_protocol) | 3 emails, seasonal 3A/3B split | nurture_longterm at end |
...
Held in Settings > Custom Fields > Opportunity > Dealer Registration. These sit on the Opportunity object, not the Contact object.
...
-   Per-session cost: $1.15 (1,300 sessions over 5 years).
...
-   $1.15 per session at 5 sessions/week over 5 years.
...
Payback at 50 clients: under 4 months against the $8,950 unit.

## At $125 per month per client
...
Payback at 50 clients: about 6 weeks.

## Delivery Model

The market is moving away from per-modality add-on pricing toward membership models. Operators position Enyrgy two ways: as a draw to bring in new members, and as an incentive to upgrade existing members into a higher tier. Where a facility runs credit-based memberships, do not price Enyrgy per session against credits, because at 4 to 5 sessions a week the credit draw would consume an entire membership and crowd out higher-margin services. Price it as a flat monthly add-on that sits outside credits, or include it in a top tier as the upgrade trigger. Enyrgy's marginal cost per session is near zero (no consumables, no practitioner, 2 to 4 minutes, app-run), unlike IV, NAD+, or practitioner-delivered services.

# SECTION 17: INVESTOR OFFERING DETAILS

## Current Valuation (NEW in v3.9.7)
...
| Per-session cost | $1.15 (5x/week, 5 years) | Consumer drip, ROI emails |
...
## Facility Referral Arrangement (NEW in v3.9.7)

Distinct from the dealer program in Section 12: different product, different terms, different people. A facility refers its own clients to buy the Consumer Unit at shop.enyrgy.com and earns $600 per Consumer Unit sale. Because the transaction is still consumer to Enyrgy, an individual buying through a facility referral link remains HSA/FSA eligible (see Section 14). Referenced in Commercial Drip Touch 7. Escalate any variation on the standard terms to Scott. Specific mechanics (attribution method and payout cadence): CONFIRM.
...
-   **$2,995 is a lot:** $1.15/session over 5 years at 5x/week. Supplements run $600-$1,200/year with absorption uncertainty. Financing available. <1% return rate.
...
**Anchor:** operators charge clients $49 to $125 per month for Enyrgy access, set by market and clientele. At 50 active clients, payback on the $8,950 unit is under 4 months at $49 per month and about 6 weeks at $125 per month. Marginal cost per session is near zero (no consumables, no practitioner, 2 to 4 minutes, app-run).

-   **We already have red light:** 90% of Enyrgy customers use both, different biological purposes. Upsell, not replacement.

-   **Would clients pay?:** About three-quarters of people have vitamin D below 30 ng/mL, so the demand is already in your book. Operators are charging $49 to $125 a month, depending on their market and clientele.

-   **Pricing model:** the market is moving from per-modality add-ons toward membership models. Position Enyrgy as a draw for new members or an upgrade trigger into a higher tier. Where a facility runs credit-based memberships, price it as a flat monthly add-on outside credits, or include it in a top tier.
...
| Winter Protocol | WF-20 | 3 emails, 3A/3B seasonal split | cub + humanize + presell-sandwich |
...
*CONFIDENTIAL, Enyrgy Inc, 5115 N 27th Ave, Bld 66, Phoenix, AZ 85017, enyrgy.com, Sunlight. Evolved., Implementation Guide v3.9.7*
