...
My co-founder David Letourneau and I had been working in the UV light space through our previous company, Anthem One, where we deployed UV-C sterilization technology adopted by Bell Helicopter and aerospace clients during COVID. We understood light-based biology at an engineering level.
...
**The dose is calculated, not timed.** The application reads each user's Fitzpatrick skin type, calculates that person's Minimum Erythemal Dose, and ends the session automatically. It also limits use to one session per day. Nobody estimates, and nobody watches a clock.
...
## What we believe, and how we say it
